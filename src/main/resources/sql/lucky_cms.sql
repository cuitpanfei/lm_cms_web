...
CREATE TABLE `sys_dept_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='部门角色关联表';
...
INSERT INTO `sys_dept_role` VALUES ('10', '9', '1003');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='菜单菜单信息表';
...
INSERT INTO `sys_menu` VALUES ('39', '38', '查看', null, 'anchor:info:list', '2', null, '0');
INSERT INTO `sys_menu` VALUES ('40', '38', '新增', null, 'anchor:info:save', '2', null, '1');
INSERT INTO `sys_menu` VALUES ('41', '38', '修改', null, 'anchor:info:update', '2', null, '2');
INSERT INTO `sys_menu` VALUES ('42', '38', '删除', null, 'anchor:info:delete', '2', null, '3');
...
CREATE TABLE `sys_menu_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COMMENT='菜单角色关联表';
...
INSERT INTO `sys_menu_role` VALUES ('65', '9', '36');
INSERT INTO `sys_menu_role` VALUES ('66', '9', '38');
INSERT INTO `sys_menu_role` VALUES ('67', '9', '39');
INSERT INTO `sys_menu_role` VALUES ('68', '9', '40');
...
) ENGINE=InnoDB AUTO_INCREMENT=1006 DEFAULT CHARSET=utf8 COMMENT='系统用户';

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '1001', 'admin', 'YzcmCZNvbXocrsz9dm8e', 'e1153123d7d180ceeb820d577ff119876678732a68eef4e6ffc0b1f06a01f91b', '13612345678', 'longmao@com', '1', '2016-11-11 11:11:11', '1');
...
INSERT INTO `sys_user` VALUES ('1005', '1003', 'anchor', 'yrMQmF6KeFGZprDJZuKz', '063221056d896f15e82b80c024731510f174de92ab0003647622a90f11dc10e2', '15267151846', '2350327011@qq.com', '1', '2018-01-26 15:43:01', '1');
...
-- ----------------------------
INSERT INTO `sys_user_token` VALUES ('1', '97332bc2624771dd9649d0eccccd9308', '2018-02-01 22:31:43', '2018-02-01 10:31:43');
INSERT INTO `sys_user_token` VALUES ('1005', 'd7f52f72c4d95d2528d5245a992888b0', '2018-01-31 22:55:26', '2018-01-31 10:55:26');
