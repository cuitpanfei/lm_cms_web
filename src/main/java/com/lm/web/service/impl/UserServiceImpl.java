...
import com.lm.web.entity.po.UserRole;
...
import com.lm.web.repository.queryFilter.UserQuery;
import com.lm.web.service.UserService;
import com.lm.web.tools.exception.ImplException;
...
public class UserServiceImpl implements UserService{
	...
	public User queryByUserName(String userName) {
		return userRepositoryDao.queryByUserName(userName);
	}
