package com.lm.web.configuration.datasource.jpa;
...
import com.lm.web.configuration.jpa.BaseSimpleJpaRepositoryEx;
...
//                       transactionManagerRef = "masterTransactionManager",
                       basePackages = {"com.lm.web.repository.dao"},//设置dao（repo）所在位置
...
public class MasterRepositoryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean masterEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.lm.web.entity.po")//设置实体类所在位置
