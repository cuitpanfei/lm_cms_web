package com.lm.web.configuration.datasource;
...
import com.lm.web.configuration.properties.DataSourceConfig;
...
//	@ConfigurationProperties(prefix = "master.spring.datasource")
	...
	public DataSource masterDataSource() throws Exception {
		GwsLogger.info("lm_cms_web 数据源初始化中...");
		System.out.println("lm_cms_web datasource init ...");
        ...
        try {
        	...
        	GwsLogger.error("jason_cms druid configuration initialization filter", e);  
        }  
        masterDruidDataSource.setConnectionProperties(dataSourceConfig.getMasterConnectionProperties());
        
		GwsLogger.info("lm_cms_web 数据源初始化成功。");
		System.out.println("lm_cms_web datasource init success...");
...
//        
//		GwsLogger.info("slave从库数据源初始化成功。");
