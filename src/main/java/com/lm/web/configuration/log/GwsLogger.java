package com.lm.web.configuration.log;
...
public final class GwsLogger {
    ...
    private static Logger interfaceLog = LogManager.getLogger(GlobalConstant.INTERFACE_LOG);
	 ...
	 * 
	 */
    public static void interfaceLogInfo(String msg) {
    ...
    private static String addImportantToLog(String msg) {
		...
		if (threadData != null) {
			...
			sb.append(String.format("action=%s,userid=%s,sid=%s,",action, threadData.getUserId(), threadData.getSid()));
			return sb.toString();
		} else {
			return msg;
		}
